...
const struct frr_yang_module_info frr_bgp_route_map_info = {
	...
	.nodes = {
		...
		{
			.xpath = "/frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:clear-as-path",
			.cbs = {
				.create = lib_route_map_entry_set_action_rmap_set_action_clear_as_path_create,
				.destroy = lib_route_map_entry_set_action_rmap_set_action_clear_as_path_destroy,
			}
		},
		{
