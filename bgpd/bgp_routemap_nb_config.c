...
/*
 * XPath:
 * /frr-route-map:lib/route-map/entry/set-action/rmap-set-action/frr-bgp-route-map:clear-as-path
 */
int
lib_route_map_entry_set_action_rmap_set_action_clear_as_path_create(
	struct nb_cb_create_args *args)
{
	struct routemap_hook_context *rhc;
	int rv;
...
int
lib_route_map_entry_set_action_rmap_set_action_clear_as_path_destroy(
	struct nb_cb_destroy_args *args)
{
	switch (args->event) {
	case NB_EV_VALIDATE:
